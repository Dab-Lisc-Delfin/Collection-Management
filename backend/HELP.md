...
* The original package name 'dld.management.collection.collection-manager' is invalid and this project uses 'dld.management.collection.collection_manager' instead.
